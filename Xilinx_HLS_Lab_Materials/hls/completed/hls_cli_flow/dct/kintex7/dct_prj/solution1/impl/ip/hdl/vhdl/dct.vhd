...
architecture behav of dct is 
    ...
    "dct,hls_ip_2016_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k70tfbg484-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.480000,HLS_SYN_LAT=2935,HLS_SYN_TPT=none,HLS_SYN_MEM=5,HLS_SYN_DSP=1,HLS_SYN_FF=246,HLS_SYN_LUT=353}";
    ...
    signal ap_reg_grp_dct_dct_2d_fu_148_ap_start : STD_LOGIC := '0';
...
begin
    ...
    ap_reg_grp_dct_dct_2d_fu_148_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_reg_grp_dct_dct_2d_fu_148_ap_start <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((exitcond1_i_fu_156_p2 = ap_const_lv1_0)))) then 
                    ap_reg_grp_dct_dct_2d_fu_148_ap_start <= ap_const_logic_1;
    ...
    begin
                ap_sig_155 <= (ap_const_lv1_1 = ap_CS_fsm(3 downto 3));
    end process;


    ap_sig_164_assign_proc : process(ap_CS_fsm)
    begin
                ap_sig_164 <= (ap_const_lv1_1 = ap_CS_fsm(4 downto 4));
    end process;
    ...
    ap_sig_cseq_ST_st4_fsm_3_assign_proc : process(ap_sig_155)
    begin
        if (ap_sig_155) then 
    ...
    ap_sig_cseq_ST_st5_fsm_4_assign_proc : process(ap_sig_164)
    begin
        if (ap_sig_164) then 
    ...
    grp_dct_dct_2d_fu_148_ap_start <= ap_reg_grp_dct_dct_2d_fu_148_ap_start;
