...
architecture behav of dct_dct_1d2 is 
    ...
    signal tmp_18_cast_reg_264 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_20_cast_fu_149_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_20_cast_reg_269 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (exitcond1_fu_153_p2 = ap_const_lv1_0))) then
                dst_addr_reg_282 <= tmp_22_cast_fu_174_p1(6 - 1 downto 0);
                    tmp_24_cast_reg_287(6 downto 3) <= tmp_24_cast_fu_187_p1(6 downto 3);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not((ap_start = ap_const_logic_0)))) then
                    tmp_18_cast_reg_264(6 downto 3) <= tmp_18_cast_fu_137_p1(6 downto 3);
                    tmp_20_cast_reg_269(6 downto 3) <= tmp_20_cast_fu_149_p1(6 downto 3);
            end if;
        end if;
    end process;
    tmp_18_cast_reg_264(2 downto 0) <= "000";
    tmp_18_cast_reg_264(7) <= '0';
    tmp_20_cast_reg_269(2 downto 0) <= "000";
    tmp_20_cast_reg_269(7) <= '0';
    tmp_24_cast_reg_287(2 downto 0) <= "000";
    tmp_24_cast_reg_287(7) <= '0';
    ...
    begin
        if ((((ap_const_logic_0 = ap_start) and (ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0)) or ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((exitcond1_fu_153_p2 = ap_const_lv1_0))))) then 
    ...
    tmp_11_fu_207_p2 <= std_logic_vector(unsigned(tmp_20_cast_reg_269) + unsigned(tmp_8_cast_fu_203_p1));
    tmp_12_fu_217_p2 <= std_logic_vector(unsigned(tmp_24_cast_reg_287) + unsigned(tmp_8_cast_fu_203_p1));
    ...
    tmp_9_fu_169_p2 <= std_logic_vector(unsigned(tmp_cast_fu_165_p1) + unsigned(tmp_18_cast_reg_264));
