; ModuleID = 'C:/training/hls/labs/hls_cli_flow/dct/kintex7/dct_prj/solution1/.autopilot/db/a.o.3.bc'
...
; <label>:5                                       ; preds = %4
  ...
  %tmp_8_cast = zext i7 %tmp_7 to i8, !dbg !37    ; [#uses=1 type=i8] [debug line = 40:10]
  %tmp_9 = add i8 %tmp_cast, %tmp_8_cast, !dbg !37 ; [#uses=1 type=i8] [debug line = 40:10]
  %tmp_9_cast = zext i8 %tmp_9 to i64, !dbg !37   ; [#uses=1 type=i64] [debug line = 40:10]
  %row_outbuf_addr = getelementptr [64 x i16]* %row_outbuf, i64 0, i64 %tmp_9_cast, !dbg !37 ; [#uses=1 type=i16*] [debug line = 40:10]
  %tmp_2 = add i8 %tmp_3_cast, %tmp_2_cast, !dbg !37 ; [#uses=1 type=i8] [debug line = 40:10]
  %tmp_10_cast = zext i8 %tmp_2 to i64, !dbg !37  ; [#uses=1 type=i64] [debug line = 40:10]
  %col_inbuf_addr = getelementptr [64 x i16]* %col_inbuf, i64 0, i64 %tmp_10_cast, !dbg !37 ; [#uses=1 type=i16*] [debug line = 40:10]
...
!2 = metadata !{i32 786473, metadata !"dct.c", metadata !"C:\5Ctraining\5Chls\5Clabs\5Chls_cli_flow\5Cdct\5Ckintex7", null} ; [ DW_TAG_file_type ]
