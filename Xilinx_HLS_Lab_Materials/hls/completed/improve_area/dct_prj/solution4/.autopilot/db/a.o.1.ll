; ModuleID = 'C:/training/hls/labs/improve_area/dct_prj/solution4/.autopilot/db/a.g.1.bc'
...
define void @dct(i16* %input, i16* %output) nounwind uwtable {
  ...
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_in}, metadata !180), !dbg !182 ; [debug line = 81:10] [debug variable = buf_2d_in]
  %buf_2d_in.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i64 0, i64 0, !dbg !183 ; [#uses=3 type=[8 x i16]*] [debug line = 82:1]
  call void (...)* @_ssdm_SpecArrayPartition([8 x i16]* %buf_2d_in.addr, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !183 ; [debug line = 82:1]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_out}, metadata !184), !dbg !185 ; [debug line = 82:10] [debug variable = buf_2d_out]
  call fastcc void @read_data(i16* %input, [8 x i16]* %buf_2d_in.addr), !dbg !186 ; [debug line = 85:4]
  %buf_2d_out.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i64 0, i64 0, !dbg !187 ; [#uses=2 type=[8 x i16]*] [debug line = 87:4]
  call fastcc void @dct_2d([8 x i16]* %buf_2d_in.addr, [8 x i16]* %buf_2d_out.addr), !dbg !187 ; [debug line = 87:4]
  call fastcc void @write_data([8 x i16]* %buf_2d_out.addr, i16* %output), !dbg !188 ; [debug line = 90:4]
...
!0 = metadata !{i32 786449, i32 0, i32 1, metadata !"C:/training/hls/labs/improve_area/dct_prj/solution4/.autopilot/db/dct.pragma.2.c", metadata !"C:\5Ctraining\5Chls\5Clabs\5Cimprove_area", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !33} ; [ DW_TAG_compile_unit ]
...
!180 = metadata !{i32 786688, metadata !178, metadata !"buf_2d_in", metadata !6, i32 81, metadata !181, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!181 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 16, i32 0, i32 0, metadata !11, metadata !38, i32 0, i32 0} ; [ DW_TAG_array_type ]
!182 = metadata !{i32 81, i32 10, metadata !178, null}
!183 = metadata !{i32 82, i32 1, metadata !178, null}
!184 = metadata !{i32 786688, metadata !178, metadata !"buf_2d_out", metadata !6, i32 82, metadata !181, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!185 = metadata !{i32 82, i32 10, metadata !178, null}
!186 = metadata !{i32 85, i32 4, metadata !178, null}
!187 = metadata !{i32 87, i32 4, metadata !178, null}
!188 = metadata !{i32 90, i32 4, metadata !178, null}
!189 = metadata !{i32 91, i32 1, metadata !178, null}
