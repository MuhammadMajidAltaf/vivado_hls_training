...
architecture behav of dct_dct_2d is 
    ...
    signal tmp_4_fu_485_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_4_reg_645 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal tmp_2_cast_fu_480_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_mid2_fu_495_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_11_cast_fu_580_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_6_cast_fu_611_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_1_cast_fu_470_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_mid2_cast_fu_458_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_2_fu_474_p2 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_10_cast_fu_570_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_s_fu_574_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_3_fu_591_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_5_cast_fu_602_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_4_cast_fu_598_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_6_fu_605_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, exitcond5_fu_406_p2, exitcond_flatten_fu_418_p2, ap_reg_ppiten_pp0_it0, exitcond2_fu_506_p2, exitcond_flatten1_fu_518_p2, ap_reg_ppiten_pp1_it0, grp_dct_dct_1d_fu_363_ap_done)
    begin
        case ap_CS_fsm is
    ...
    begin
                ap_sig_325 <= (ap_const_lv1_1 = ap_CS_fsm(2 downto 2));
    end process;
    ...
    begin
                ap_sig_594 <= (ap_const_lv1_1 = ap_CS_fsm(7 downto 7));
    end process;


    ap_sig_cseq_ST_pp0_stg0_fsm_3_assign_proc : process(ap_sig_115)
    begin
        if (ap_sig_115) then 
    ...
    ap_sig_cseq_ST_pp1_stg0_fsm_6_assign_proc : process(ap_sig_154)
    begin
        if (ap_sig_154) then 
    ...
    ap_sig_cseq_ST_st10_fsm_7_assign_proc : process(ap_sig_594)
    begin
        if (ap_sig_594) then 
    ...
    ap_sig_cseq_ST_st3_fsm_2_assign_proc : process(ap_sig_325)
    begin
        if (ap_sig_325) then 
    ...
    ap_sig_cseq_ST_st6_fsm_4_assign_proc : process(ap_sig_143)
    begin
        if (ap_sig_143) then 
    ...
    ap_sig_cseq_ST_st7_fsm_5_assign_proc : process(ap_sig_344)
    begin
        if (ap_sig_344) then 
    ...
    col_inbuf_0_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_645)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_4_reg_645 = ap_const_lv3_0)))) then 
    ...
    col_inbuf_1_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_645)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_4_reg_645 = ap_const_lv3_1)))) then 
    ...
    col_inbuf_2_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_645)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_4_reg_645 = ap_const_lv3_2)))) then 
    ...
    col_inbuf_3_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_645)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_4_reg_645 = ap_const_lv3_3)))) then 
    ...
    col_inbuf_4_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_645)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_4_reg_645 = ap_const_lv3_4)))) then 
    ...
    col_inbuf_5_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_645)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_4_reg_645 = ap_const_lv3_5)))) then 
    ...
    col_inbuf_6_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_645)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_4_reg_645 = ap_const_lv3_6)))) then 
    ...
    col_inbuf_7_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_4_reg_645)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_4_reg_645 = ap_const_lv3_7)))) then 
    ...
    col_outbuf_address0_assign_proc : process(ap_sig_cseq_ST_pp1_stg0_fsm_6, ap_reg_ppiten_pp1_it0, grp_dct_dct_1d_fu_363_dst_address0, ap_sig_cseq_ST_st7_fsm_5, tmp_11_cast_fu_580_p1)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_6) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it0))) then 
            col_outbuf_address0 <= tmp_11_cast_fu_580_p1(6 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_5)) then 
    ...
    out_block_address0 <= tmp_6_cast_fu_611_p1(6 - 1 downto 0);
    ...
    row_outbuf_address0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it0, grp_dct_dct_1d_fu_363_dst_address0, ap_sig_cseq_ST_st3_fsm_2, tmp_2_cast_fu_480_p1)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it0))) then 
            row_outbuf_address0 <= tmp_2_cast_fu_480_p1(6 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2)) then 
    ...
    tmp_10_cast_fu_570_p1 <= std_logic_vector(resize(unsigned(tmp_8_fu_562_p3),8));
    tmp_11_cast_fu_580_p1 <= std_logic_vector(resize(unsigned(tmp_s_fu_574_p2),64));
    tmp_1_cast_fu_470_p1 <= std_logic_vector(resize(unsigned(tmp_fu_462_p3),8));
    tmp_2_cast_fu_480_p1 <= std_logic_vector(resize(unsigned(tmp_2_fu_474_p2),64));
    tmp_2_fu_474_p2 <= std_logic_vector(unsigned(tmp_1_cast_fu_470_p1) + unsigned(tmp_mid2_cast_fu_458_p1));
    tmp_3_fu_591_p3 <= (tmp_4_mid2_v_reg_677 & ap_const_lv3_0);
    tmp_4_cast_fu_598_p1 <= std_logic_vector(resize(unsigned(tmp_3_fu_591_p3),8));
    tmp_4_fu_485_p1 <= i_1_mid2_fu_442_p3(3 - 1 downto 0);
    ...
    tmp_6_cast_fu_611_p1 <= std_logic_vector(resize(unsigned(tmp_6_fu_605_p2),64));
    tmp_6_fu_605_p2 <= std_logic_vector(unsigned(tmp_5_cast_fu_602_p1) + unsigned(tmp_4_cast_fu_598_p1));
    tmp_8_fu_562_p3 <= (i_3_mid2_fu_542_p3 & ap_const_lv3_0);
    ...
    tmp_mid2_v_fu_450_p3 <= 
        ...
        j_phi_fu_300_p4;
    tmp_s_fu_574_p2 <= std_logic_vector(unsigned(tmp_4_mid2_cast_fu_558_p1) + unsigned(tmp_10_cast_fu_570_p1));
end behav;
