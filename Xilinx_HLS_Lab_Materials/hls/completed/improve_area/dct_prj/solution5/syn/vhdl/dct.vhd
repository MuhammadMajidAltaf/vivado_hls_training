...
architecture behav of dct is 
    ...
    "dct,hls_ip_2016_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.790000,HLS_SYN_LAT=507,HLS_SYN_TPT=374,HLS_SYN_MEM=4,HLS_SYN_DSP=8,HLS_SYN_FF=1505,HLS_SYN_LUT=613}";
...
begin
    ...
    dct_dct_2d_U0_ap_continue <= buf_2d_out_i_full_n;
    ...
    dct_read_data_U0_ap_continue_assign_proc : process(ap_sig_dct_read_data_U0_buf_6_pipo_status, ap_sig_dct_read_data_U0_buf_5_pipo_status, ap_sig_dct_read_data_U0_buf_4_pipo_status, ap_sig_dct_read_data_U0_buf_3_pipo_status, ap_sig_dct_read_data_U0_buf_2_pipo_status, ap_sig_dct_read_data_U0_buf_1_pipo_status, ap_sig_dct_read_data_U0_buf_0_pipo_status, ap_sig_dct_read_data_U0_buf_7_pipo_status)
    begin
        if (((ap_const_logic_1 = ap_sig_dct_read_data_U0_buf_6_pipo_status) and (ap_const_logic_1 = ap_sig_dct_read_data_U0_buf_5_pipo_status) and (ap_const_logic_1 = ap_sig_dct_read_data_U0_buf_4_pipo_status) and (ap_const_logic_1 = ap_sig_dct_read_data_U0_buf_3_pipo_status) and (ap_const_logic_1 = ap_sig_dct_read_data_U0_buf_2_pipo_status) and (ap_const_logic_1 = ap_sig_dct_read_data_U0_buf_1_pipo_status) and (ap_const_logic_1 = ap_sig_dct_read_data_U0_buf_0_pipo_status) and (ap_const_logic_1 = ap_sig_dct_read_data_U0_buf_7_pipo_status))) then 
