...
wire   [7:0] tmp_8_fu_353_p2;
reg   [7:0] tmp_8_reg_546;
reg   [7:0] ap_reg_ppstg_tmp_8_reg_546_pp0_iter1;
reg   [7:0] ap_reg_ppstg_tmp_8_reg_546_pp0_iter2;
reg   [7:0] ap_reg_ppstg_tmp_8_reg_546_pp0_iter3;
...
dct_mac_muladd_15s_16s_29s_29_1 #(
    ...
    .din2_WIDTH( 29 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_15s_16s_29s_29_1_U15(
...
dct_mac_muladd_15s_16s_14ns_29_1 #(
    ...
    .din2_WIDTH( 14 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_15s_16s_14ns_29_1_U16(
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~(ap_start == 1'b0))) begin
        ...
        tmp_18_cast_reg_492[6 : 3] <= tmp_18_cast_fu_309_p1[6 : 3];
    end
end
...
assign dst_address0 = tmp_19_cast_fu_430_p1;
...
assign grp_fu_450_p00 = ap_reg_ppstg_dct_coeff_table_0_load_reg_591_pp0_iter2;

assign grp_fu_483_p2 = ap_const_lv29_1000;
...
assign tmp1_fu_406_p2 = ($signed(grp_fu_450_p3) + $signed(grp_fu_442_p3));

assign tmp4_fu_410_p2 = ($signed(grp_fu_434_p3) + $signed(tmp6_reg_686));

assign tmp_18_cast_fu_309_p1 = tmp_6_fu_301_p3;

assign tmp_19_cast_fu_430_p1 = ap_reg_ppstg_tmp_8_reg_546_pp0_iter3;

assign tmp_2_cast_fu_313_p1 = tmp_2;

assign tmp_6_fu_301_p3 = {{tmp_21}, {ap_const_lv3_0}};

assign tmp_8_fu_353_p2 = (tmp_18_cast_reg_492 + tmp_cast_fu_349_p1);
...
always @ (posedge ap_clk) begin
    tmp_18_cast_reg_492[2:0] <= 3'b000;
    tmp_18_cast_reg_492[7] <= 1'b0;
end
