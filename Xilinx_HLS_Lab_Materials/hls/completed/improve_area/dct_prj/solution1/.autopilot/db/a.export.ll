...
; <label>:5                                       ; preds = %4
  ...
  %tmp_7 = add i8 %tmp_3_cast, %tmp_2_cast
  %tmp_7_cast = zext i8 %tmp_7 to i64
  %col_inbuf_addr = getelementptr [64 x i16]* %col_inbuf, i64 0, i64 %tmp_7_cast
  %tmp_8 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_1, i3 0)
  %tmp_9_cast = zext i7 %tmp_8 to i8
  %tmp_2 = add i8 %tmp_cast, %tmp_9_cast
...
; <label>:4                                       ; preds = %3
  ...
  %input_addr = getelementptr [64 x i16]* %input, i64 0, i64 %tmp_i_15
