...
reg   [3:0] k_i_reg_158;
wire   [0:0] exitcond2_i_fu_169_p2;
reg    ap_sig_cseq_ST_st2_fsm_1;
reg    ap_sig_57;
wire   [3:0] i_fu_175_p2;
reg   [3:0] i_reg_510;
wire   [7:0] tmp_21_cast_fu_194_p1;
reg   [7:0] tmp_21_cast_reg_515;
reg   [2:0] col_inbuf_addr_reg_520;
...
wire   [7:0] tmp_4_fu_219_p2;
reg   [7:0] tmp_4_reg_534;
reg   [7:0] ap_reg_ppstg_tmp_4_reg_534_pp0_iter1;
reg   [7:0] ap_reg_ppstg_tmp_4_reg_534_pp0_iter2;
reg   [7:0] ap_reg_ppstg_tmp_4_reg_534_pp0_iter3;
wire   [15:0] tmp_51_fu_224_p1;
reg  signed [15:0] tmp_51_reg_544;
wire   [15:0] tmp_52_fu_228_p1;
reg  signed [15:0] tmp_52_reg_549;
...
reg  signed [14:0] tmp_2_reg_614;
reg  signed [15:0] tmp_23_i_reg_619;
wire  signed [28:0] tmp_6_i_fu_500_p2;
reg  signed [28:0] tmp_6_i_reg_624;
wire  signed [28:0] tmp_6_2_i_fu_494_p2;
reg  signed [28:0] tmp_6_2_i_reg_629;
wire  signed [28:0] tmp_6_4_i_fu_488_p2;
...
wire   [63:0] tmp_22_cast_fu_444_p1;
...
dct_mac_muladd_16s_16s_29s_29_1 #(
    ...
    .din2_WIDTH( 29 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_16s_16s_29s_29_1_U15(
...
dct_mac_muladd_16s_15s_14ns_29_1 #(
    ...
    .din2_WIDTH( 14 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_16s_15s_14ns_29_1_U16(
...
dct_mac_muladd_16s_16s_29s_29_1 #(
    ...
    .din2_WIDTH( 29 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_16s_16s_29s_29_1_U17(
...
dct_mac_muladd_16s_16s_29s_29_1 #(
    ...
    .din2_WIDTH( 29 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_16s_16s_29s_29_1_U18(
...
dct_mac_muladd_16s_16s_29s_29_1 #(
    ...
    .din2_WIDTH( 29 ),
    .dout_WIDTH( 29 ))
dct_mac_muladd_16s_16s_29s_29_1_U19(
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(exitcond2_i_fu_169_p2 == 1'b0))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (exitcond2_i_fu_169_p2 == 1'b0)) | ((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & ~(1'b0 == exitcond1_i_fu_198_p2)))) begin
            ap_reg_ppiten_pp0_it1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (exitcond2_i_fu_169_p2 == 1'b0))) begin
        col_inbuf_addr_reg_520 <= tmp_81_cast_i_fu_181_p1;
        tmp_21_cast_reg_515[6 : 3] <= tmp_21_cast_fu_194_p1[6 : 3];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & (1'b0 == exitcond1_i_reg_525))) begin
        ...
        tmp_11_i_reg_559 <= {{col_inbuf_q0[ap_const_lv9_1F : ap_const_lv9_10]}};
        tmp_12_i_reg_564 <= {{dct_coeff_table_q0[ap_const_lv32_2F : ap_const_lv32_20]}};
        tmp_13_i_reg_569 <= {{col_inbuf_q0[ap_const_lv9_2F : ap_const_lv9_20]}};
        tmp_14_i_reg_574 <= {{dct_coeff_table_q0[ap_const_lv32_3F : ap_const_lv32_30]}};
        tmp_15_i_reg_579 <= {{col_inbuf_q0[ap_const_lv9_3F : ap_const_lv9_30]}};
        tmp_16_i_reg_584 <= {{dct_coeff_table_q0[ap_const_lv32_4F : ap_const_lv32_40]}};
        tmp_17_i_reg_589 <= {{col_inbuf_q0[ap_const_lv9_4F : ap_const_lv9_40]}};
        tmp_18_i_reg_594 <= {{dct_coeff_table_q0[ap_const_lv32_5F : ap_const_lv32_50]}};
        tmp_19_i_reg_599 <= {{col_inbuf_q0[ap_const_lv9_5F : ap_const_lv9_50]}};
        tmp_20_i_reg_604 <= {{dct_coeff_table_q0[ap_const_lv32_6F : ap_const_lv32_60]}};
        tmp_21_i_reg_609 <= {{col_inbuf_q0[ap_const_lv9_6F : ap_const_lv9_60]}};
        tmp_23_i_reg_619 <= {{col_inbuf_q0[ap_const_lv9_7F : ap_const_lv9_70]}};
        tmp_2_reg_614 <= {{dct_coeff_table_q0[ap_const_lv32_7E : ap_const_lv32_70]}};
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_reg_ppstg_exitcond1_i_reg_525_pp0_iter2)) begin
        tmp_3_i_reg_644 <= {{tmp_i_32_fu_428_p2[ap_const_lv32_1C : ap_const_lv32_D]}};
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(exitcond2_i_fu_169_p2 == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st2_fsm_1 : begin
            if (~(exitcond2_i_fu_169_p2 == 1'b0)) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else begin
...
assign col_inbuf_address0 = col_inbuf_addr_reg_520;

assign col_outbuf_i_address0 = tmp_22_cast_fu_444_p1;

assign col_outbuf_i_d0 = tmp_3_i_reg_644;

assign dct_coeff_table_address0 = tmp_i_fu_210_p1;

assign exitcond1_i_fu_198_p2 = ((k_i_reg_158 == ap_const_lv4_8) ? 1'b1 : 1'b0);

assign exitcond2_i_fu_169_p2 = ((i_2_i_reg_147 == ap_const_lv4_8) ? 1'b1 : 1'b0);

assign grp_fu_455_p2 = ap_const_lv29_1000;

assign i_fu_175_p2 = (i_2_i_reg_147 + ap_const_lv4_1);

assign k_fu_204_p2 = (k_i_reg_158 + ap_const_lv4_1);

assign tmp3_fu_424_p2 = ($signed(tmp5_reg_639) + $signed(grp_fu_464_p3));

assign tmp_21_cast_fu_194_p1 = tmp_s_fu_186_p3;

assign tmp_22_cast_fu_444_p1 = ap_reg_ppstg_tmp_4_reg_534_pp0_iter3;

assign tmp_4_fu_219_p2 = (tmp_i_cast_fu_215_p1 + tmp_21_cast_reg_515);

assign tmp_51_fu_224_p1 = dct_coeff_table_q0[15:0];

assign tmp_52_fu_228_p1 = col_inbuf_q0[15:0];

assign tmp_81_cast_i_fu_181_p1 = i_2_i_reg_147;

assign tmp_fu_420_p2 = ($signed(grp_fu_472_p3) + $signed(grp_fu_480_p3));

assign tmp_i_32_fu_428_p2 = (tmp3_fu_424_p2 + tmp_fu_420_p2);

assign tmp_i_cast_fu_215_p1 = k_i_reg_158;

assign tmp_i_fu_210_p1 = k_i_reg_158;

assign tmp_s_fu_186_p3 = {{i_2_i_reg_147}, {ap_const_lv3_0}};

always @ (posedge ap_clk) begin
    tmp_21_cast_reg_515[2:0] <= 3'b000;
    tmp_21_cast_reg_515[7] <= 1'b0;
end
