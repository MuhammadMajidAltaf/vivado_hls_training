...
architecture behav of dct_Loop_Xpose_Row_Outer_Loop_proc is 
    ...
    signal tmp_mid2_v_fu_253_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_mid2_v_reg_318 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_3_fu_288_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_3_reg_329 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal tmp_9_cast_fu_283_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_mid2_fu_298_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal exitcond3_i2_fu_239_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_8_cast_fu_273_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_mid2_cast_fu_261_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_9_fu_277_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not(ap_sig_127)) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and not((exitcond_flatten_fu_221_p2 = ap_const_lv1_0))))) then 
                    ap_reg_ppiten_pp0_it1 <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, exitcond_flatten_fu_221_p2, ap_reg_ppiten_pp0_it0, ap_sig_127)
    begin
        case ap_CS_fsm is
    ...
    ap_sig_cseq_ST_pp0_stg0_fsm_1_assign_proc : process(ap_sig_103)
    begin
        if (ap_sig_103) then 
    ...
    ap_sig_cseq_ST_st4_fsm_2_assign_proc : process(ap_sig_238)
    begin
        if (ap_sig_238) then 
    ...
    col_inbuf_0_address0 <= tmp_mid2_fu_298_p1(3 - 1 downto 0);
    ...
    col_inbuf_0_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_329)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_3_reg_329 = ap_const_lv3_0)))) then 
    ...
    col_inbuf_1_address0 <= tmp_mid2_fu_298_p1(3 - 1 downto 0);
    ...
    col_inbuf_1_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_329)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_3_reg_329 = ap_const_lv3_1)))) then 
    ...
    col_inbuf_2_address0 <= tmp_mid2_fu_298_p1(3 - 1 downto 0);
    ...
    col_inbuf_2_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_329)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_3_reg_329 = ap_const_lv3_2)))) then 
    ...
    col_inbuf_3_address0 <= tmp_mid2_fu_298_p1(3 - 1 downto 0);
    ...
    col_inbuf_3_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_329)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_3_reg_329 = ap_const_lv3_3)))) then 
    ...
    col_inbuf_4_address0 <= tmp_mid2_fu_298_p1(3 - 1 downto 0);
    ...
    col_inbuf_4_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_329)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_3_reg_329 = ap_const_lv3_4)))) then 
    ...
    col_inbuf_5_address0 <= tmp_mid2_fu_298_p1(3 - 1 downto 0);
    ...
    col_inbuf_5_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_329)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_3_reg_329 = ap_const_lv3_5)))) then 
    ...
    col_inbuf_6_address0 <= tmp_mid2_fu_298_p1(3 - 1 downto 0);
    ...
    col_inbuf_6_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_329)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_3_reg_329 = ap_const_lv3_6)))) then 
    ...
    col_inbuf_7_address0 <= tmp_mid2_fu_298_p1(3 - 1 downto 0);
    ...
    col_inbuf_7_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_329)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_3_reg_329 = ap_const_lv3_7)))) then 
    ...
    exitcond3_i2_fu_239_p2 <= "1" when (i_1_i_reg_210 = ap_const_lv4_8) else "0";
    exitcond_flatten_fu_221_p2 <= "1" when (indvar_flatten_reg_188 = ap_const_lv7_40) else "0";
    i_1_i_mid2_fu_245_p3 <= 
        ap_const_lv4_0 when (exitcond3_i2_fu_239_p2(0) = '1') else 
        i_1_i_reg_210;
    i_fu_292_p2 <= std_logic_vector(unsigned(i_1_i_mid2_fu_245_p3) + unsigned(ap_const_lv4_1));
    indvar_flatten_next_fu_227_p2 <= std_logic_vector(unsigned(indvar_flatten_reg_188) + unsigned(ap_const_lv7_1));

    j_0_i_phi_fu_203_p4_assign_proc : process(j_0_i_reg_199, exitcond_flatten_reg_309, ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_mid2_v_reg_318)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (exitcond_flatten_reg_309 = ap_const_lv1_0))) then 
    ...
    row_outbuf_i_address0 <= tmp_9_cast_fu_283_p1(6 - 1 downto 0);
    ...
    tmp_3_fu_288_p1 <= i_1_i_mid2_fu_245_p3(3 - 1 downto 0);
    tmp_8_cast_fu_273_p1 <= std_logic_vector(resize(unsigned(tmp_fu_265_p3),8));
    tmp_9_cast_fu_283_p1 <= std_logic_vector(resize(unsigned(tmp_9_fu_277_p2),64));
    tmp_9_fu_277_p2 <= std_logic_vector(unsigned(tmp_8_cast_fu_273_p1) + unsigned(tmp_mid2_cast_fu_261_p1));
    tmp_fu_265_p3 <= (i_1_i_mid2_fu_245_p3 & ap_const_lv3_0);
    tmp_mid2_cast_fu_261_p1 <= std_logic_vector(resize(unsigned(tmp_mid2_v_fu_253_p3),8));
    tmp_mid2_fu_298_p1 <= std_logic_vector(resize(unsigned(tmp_mid2_v_reg_318),64));
    tmp_mid2_v_fu_253_p3 <= 
        j_fu_233_p2 when (exitcond3_i2_fu_239_p2(0) = '1') else 
        j_0_i_phi_fu_203_p4;
end behav;
