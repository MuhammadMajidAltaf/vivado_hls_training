...
dct_read_data::dct_read_data(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_c_2_fu_292_p2);
    sensitive << ( c_mid2_fu_245_p3 );

    SC_METHOD(thread_c_cast_fu_273_p1);
    sensitive << ( c_mid2_fu_245_p3 );
    ...
    sc_trace(mVcdFile, c_2_fu_292_p2, "c_2_fu_292_p2");
    ...
    sc_trace(mVcdFile, c_cast_fu_273_p1, "c_cast_fu_273_p1");
...
void dct_read_data::thread_c_2_fu_292_p2() {
    c_2_fu_292_p2 = (!c_mid2_fu_245_p3.read().is_01() || !ap_const_lv4_1.is_01())? sc_lv<4>(): (sc_biguint<4>(c_mid2_fu_245_p3.read()) + sc_biguint<4>(ap_const_lv4_1));
}

void dct_read_data::thread_c_cast_fu_273_p1() {
    c_cast_fu_273_p1 = esl_zext<6,4>(c_mid2_fu_245_p3.read());
}
...
void dct_read_data::thread_r_2_fu_233_p2() {
...
void dct_read_data::thread_tmp_9_fu_277_p2() {
    tmp_9_fu_277_p2 = (!c_cast_fu_273_p1.read().is_01() || !tmp_mid2_fu_265_p3.read().is_01())? sc_lv<6>(): (sc_biguint<6>(c_cast_fu_273_p1.read()) + sc_biguint<6>(tmp_mid2_fu_265_p3.read()));
}
