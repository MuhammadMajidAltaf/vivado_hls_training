...
dct_Loop_Xpose_Col_Outer_Loop_proc::dct_Loop_Xpose_Col_Outer_Loop_proc(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_14_cast_fu_197_p1 );
    ...
    sensitive << ( tmp_13_cast_fu_166_p1 );
    ...
    SC_METHOD(thread_tmp_12_cast_fu_156_p1);
    sensitive << ( tmp_s_fu_148_p3 );

    SC_METHOD(thread_tmp_13_cast_fu_166_p1);
    sensitive << ( tmp_1_fu_160_p2 );

    SC_METHOD(thread_tmp_14_cast_fu_197_p1);
    sensitive << ( tmp_2_fu_191_p2 );

    SC_METHOD(thread_tmp_1_fu_160_p2);
    sensitive << ( tmp_1_mid2_cast_fu_144_p1 );
    sensitive << ( tmp_12_cast_fu_156_p1 );
    ...
    sc_trace(mVcdFile, tmp_13_cast_fu_166_p1, "tmp_13_cast_fu_166_p1");
    sc_trace(mVcdFile, tmp_14_cast_fu_197_p1, "tmp_14_cast_fu_197_p1");
    ...
    sc_trace(mVcdFile, tmp_12_cast_fu_156_p1, "tmp_12_cast_fu_156_p1");
...
void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_buf_2d_out_address0() {
    buf_2d_out_address0 =  (sc_lv<6>) (tmp_14_cast_fu_197_p1.read());
}
...
void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_col_outbuf_i_address0() {
    col_outbuf_i_address0 =  (sc_lv<6>) (tmp_13_cast_fu_166_p1.read());
}
...
void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_10_cast_fu_184_p1() {
    tmp_10_cast_fu_184_p1 = esl_zext<8,7>(tmp_fu_177_p3.read());
}

void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_12_cast_fu_156_p1() {
    tmp_12_cast_fu_156_p1 = esl_zext<8,7>(tmp_s_fu_148_p3.read());
}

void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_13_cast_fu_166_p1() {
    tmp_13_cast_fu_166_p1 = esl_zext<64,8>(tmp_1_fu_160_p2.read());
}

void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_14_cast_fu_197_p1() {
    tmp_14_cast_fu_197_p1 = esl_zext<64,8>(tmp_2_fu_191_p2.read());
}

void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_1_fu_160_p2() {
    tmp_1_fu_160_p2 = (!tmp_1_mid2_cast_fu_144_p1.read().is_01() || !tmp_12_cast_fu_156_p1.read().is_01())? sc_lv<8>(): (sc_biguint<8>(tmp_1_mid2_cast_fu_144_p1.read()) + sc_biguint<8>(tmp_12_cast_fu_156_p1.read()));
}
...
void dct_Loop_Xpose_Col_Outer_Loop_proc::thread_tmp_2_fu_191_p2() {
    tmp_2_fu_191_p2 = (!tmp_2_cast_fu_188_p1.read().is_01() || !tmp_10_cast_fu_184_p1.read().is_01())? sc_lv<8>(): (sc_biguint<8>(tmp_2_cast_fu_188_p1.read()) + sc_biguint<8>(tmp_10_cast_fu_184_p1.read()));
}
