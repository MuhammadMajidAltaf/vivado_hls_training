...
HD_PWD='C:/training/hls/labs/improve_performance/yuv_filter_prj/solution3/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log yuv_filter.vds -m64 -mode batch -messageDb vivado.pb -notrace -source yuv_filter.tcl
