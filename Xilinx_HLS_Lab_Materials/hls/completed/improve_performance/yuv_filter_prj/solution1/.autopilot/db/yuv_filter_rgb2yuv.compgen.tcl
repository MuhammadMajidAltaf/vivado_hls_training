...
set id 0
set name yuv_filter_mac_muladd_8ns_8s_16ns_16_1
...
set out_width 16
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {8 1 +} m {16 1 +} i2 {16 0 +} p {16 1 +} c_reg {1} }
...
set id 1
set name yuv_filter_mac_muladd_8ns_7s_16ns_16_1
set corename simcore_mac
set op mac
set stage_num 1
set max_latency -1
...
set out_width 16
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {7 1 +} m {15 1 +} i2 {16 0 +} p {16 1 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
    id ${id} \
...
set id 2
set name yuv_filter_mac_muladd_8ns_6ns_9ns_13_1
set corename simcore_mac
set op mac
set stage_num 1
set max_latency -1
...
set out_width 13
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {6 0 +} m {13 0 +} i2 {9 0 +} p {13 0 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
    id ${id} \
