...
set id 2
set name yuv_filter_mac_muladd_7s_8ns_16ns_16_1
set corename simcore_mac
set op mac
set stage_num 1
set max_latency -1
...
set out_width 16
set exp i0*i1+i2
set arg_lists {i0 {7 1 +} i1 {8 0 +} m {15 1 +} i2 {16 0 +} p {16 1 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
    id ${id} \
...
set id 3
set name yuv_filter_mac_muladd_6ns_8ns_9ns_13_1
set corename simcore_mac
set op mac
set stage_num 1
set max_latency -1
