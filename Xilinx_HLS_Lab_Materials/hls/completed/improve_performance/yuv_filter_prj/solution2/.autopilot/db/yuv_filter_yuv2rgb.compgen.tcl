...
set id 13
set name yuv_filter_mac_muladd_8s_8s_17ns_17_1
...
set out_width 17
set exp i0*i1+i2
set arg_lists {i0 {8 1 +} i1 {8 1 +} m {16 1 +} i2 {17 0 +} p {17 1 +} c_reg {1} }
...
set id 14
set name yuv_filter_ama_addmuladd_5s_8ns_10ns_9ns_18_1
...
set out_width 18
set exp (i0+i1)*i2+i3
set arg_lists {i0 {5 1 +} i1 {8 0 +} s {9 1 +} i2 {10 0 +} m {18 1 +} i3 {9 0 +} p {18 1 +} c_expval {c} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
...
set id 15
set name yuv_filter_mac_muladd_10ns_8s_18s_18_1
set corename simcore_mac
set op mac
set stage_num 1
set max_latency -1
...
set out_width 18
set exp i0*i1+i2
set arg_lists {i0 {10 0 +} i1 {8 1 +} m {18 1 +} i2 {18 1 +} p {18 1 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
    id ${id} \
