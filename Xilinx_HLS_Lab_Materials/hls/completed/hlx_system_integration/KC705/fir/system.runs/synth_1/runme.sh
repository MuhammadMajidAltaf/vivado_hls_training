...
HD_PWD='C:/training/hls/labs/hlx_flow/KC705/fir/system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_design_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source microblaze_design_wrapper.tcl
