...
HD_PWD='C:/training/hls/labs/hlx_flow/KC705/fir/system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_design_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source microblaze_design_wrapper.tcl -notrace
