...
#
# Generated by export_simulation on Fri Apr 29 12:48:31 +0530 2016
#
################################################################################
...
switch to the './microblaze_design.sh' script.

./microblaze_design.sh -reset_run
...
./microblaze_design.sh -noclean_files

For more information on the script, please type './microblaze_design.sh -help'.
