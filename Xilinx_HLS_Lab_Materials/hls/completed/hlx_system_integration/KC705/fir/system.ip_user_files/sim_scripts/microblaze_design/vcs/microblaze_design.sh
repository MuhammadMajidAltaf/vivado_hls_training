...
#
# Generated by Vivado on Fri Apr 29 12:48:31 +0530 2016
# IP Build 1537824 on Fri Apr  8 04:28:57 MDT 2016 
#
# usage: microblaze_design.sh [-help]
# usage: microblaze_design.sh [-lib_map_path]
# usage: microblaze_design.sh [-noclean_files]
# usage: microblaze_design.sh [-reset_run]
#
...
# executing this script. Please type 'microblaze_design.sh -help' for more information.
#
...
# Script info
echo -e "microblaze_design.sh - Script generated by export_simulation (Vivado v2016.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/microblaze_design/ip/microblaze_design_microblaze_0_0/sim/microblaze_design_microblaze_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/microblaze_design/ip/microblaze_design_dlmb_v10_0/sim/microblaze_design_dlmb_v10_0.vhd" \
    "$ref_dir/../../../bd/microblaze_design/ip/microblaze_design_ilmb_v10_0/sim/microblaze_design_ilmb_v10_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/microblaze_design/ip/microblaze_design_dlmb_bram_if_cntlr_0/sim/microblaze_design_dlmb_bram_if_cntlr_0.vhd" \
    "$ref_dir/../../../bd/microblaze_design/ip/microblaze_design_ilmb_bram_if_cntlr_0/sim/microblaze_design_ilmb_bram_if_cntlr_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/clk_wiz_v5_3" \
    "$ref_dir/../../../bd/microblaze_design/ip/microblaze_design_lmb_bram_0/sim/microblaze_design_lmb_bram_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work axi_intc_v4_1_6 $vhdlan_opts \
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/microblaze_design/ip/microblaze_design_microblaze_0_axi_intc_0/sim/microblaze_design_microblaze_0_axi_intc_0.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/clk_wiz_v5_3" \
    "$ref_dir/../../../bd/microblaze_design/ipshared/xilinx.com/xlconcat_v2_1/xlconcat.v" \
    "$ref_dir/../../../bd/microblaze_design/ip/microblaze_design_microblaze_0_xlconcat_0/sim/microblaze_design_microblaze_0_xlconcat_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/microblaze_design/ip/microblaze_design_mdm_1_0/sim/microblaze_design_mdm_1_0.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/clk_wiz_v5_3" \
    "$ref_dir/../../../bd/microblaze_design/ip/microblaze_design_clk_wiz_1_0/microblaze_design_clk_wiz_1_0_clk_wiz.v" \
    "$ref_dir/../../../bd/microblaze_design/ip/microblaze_design_clk_wiz_1_0/microblaze_design_clk_wiz_1_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/microblaze_design/ip/microblaze_design_rst_clk_wiz_1_100M_0/sim/microblaze_design_rst_clk_wiz_1_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/microblaze_design/ip/microblaze_design_axi_uartlite_0_0/sim/microblaze_design_axi_uartlite_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/clk_wiz_v5_3" \
    "$ref_dir/../../../bd/microblaze_design/ip/microblaze_design_xbar_0/sim/microblaze_design_xbar_0.v" \
    "$ref_dir/../../../ipstatic/fir_v1_0/hdl/verilog/fir.v" \
    "$ref_dir/../../../ipstatic/fir_v1_0/hdl/verilog/fir_c.v" \
    "$ref_dir/../../../ipstatic/fir_v1_0/hdl/verilog/fir_fir_io_s_axi.v" \
    "$ref_dir/../../../ipstatic/fir_v1_0/hdl/verilog/fir_shift_reg.v" \
    "$ref_dir/../../../bd/microblaze_design/ip/microblaze_design_fir_0_0/sim/microblaze_design_fir_0_0.v" \
    "$ref_dir/../../../bd/microblaze_design/hdl/microblaze_design.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.microblaze_design xil_defaultlib.glbl -o microblaze_design_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./microblaze_design_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./microblaze_design.sh -help\" for more information)\n"
        exit 1
      fi
...
create_lib_mappings()
{
  libs=(xil_defaultlib xpm microblaze_v9_6_0 lmb_v10_v3_0_8 lmb_bram_if_cntlr_v4_0_8 blk_mem_gen_v8_3_2 axi_lite_ipif_v3_0_3 axi_intc_v4_1_6 mdm_v3_2_5 lib_cdc_v1_0_2 proc_sys_reset_v5_0_9 lib_pkg_v1_0_2 lib_srl_fifo_v1_0_2 axi_uartlite_v2_0_12 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_8 fifo_generator_v13_1_0 axi_data_fifo_v2_1_7 axi_crossbar_v2_1_9)
...
reset_run()
{
  files_to_remove=(ucli.key microblaze_design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc microblaze_design_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./microblaze_design.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: microblaze_design.sh [-help]\n\
Usage: microblaze_design.sh [-lib_map_path]\n\
Usage: microblaze_design.sh [-reset_run]\n\
Usage: microblaze_design.sh [-noclean_files]\n\n\
