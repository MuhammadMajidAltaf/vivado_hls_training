...
HD_PWD='C:/training/hls/labs/hlx_flow/KC705/fir/fir_prj/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fir.tcl
