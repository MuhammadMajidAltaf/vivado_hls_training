...
define void @adders_io(i32 %in1, i32 %in2, i32* %in_out1) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32* %in_out1, [6 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1) nounwind, !dbg !35 ; [debug line = 49:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in2, [7 x i8]* @.str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1) nounwind, !dbg !35 ; [debug line = 49:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in1, [7 x i8]* @.str3, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1) nounwind, !dbg !35 ; [debug line = 49:1]
...
!0 = metadata !{i32 786449, i32 0, i32 1, metadata !"C:/training/hls/labs/interface_synthesis/adders_io_prj/solution1/.autopilot/db/adders_io.pragma.2.c", metadata !"C:\5Ctraining\5Chls\5Clabs\5Cinterface_synthesis", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !1} ; [ DW_TAG_compile_unit ]
...
!6 = metadata !{i32 786473, metadata !"adders_io.c", metadata !"C:\5Ctraining\5Chls\5Clabs\5Cinterface_synthesis", null} ; [ DW_TAG_file_type ]
