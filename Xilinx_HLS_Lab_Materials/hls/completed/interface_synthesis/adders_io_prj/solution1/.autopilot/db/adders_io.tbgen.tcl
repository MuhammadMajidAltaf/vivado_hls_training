...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : [], "CDFG" : "adders_io", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		{"Name" : "in1", "Type" : "Vld", "Direction" : "I", "BlockSignal" : [
			{"Name" : "in1_blk_n", "Type" : "RtlSignal"}], "SubConnect" : []}, 
		{"Name" : "in2", "Type" : "Ack", "Direction" : "I", "BlockSignal" : [], "SubConnect" : []}, 
		{"Name" : "in_out1", "Type" : "HS", "Direction" : "IO", "BlockSignal" : [
			{"Name" : "in_out1_blk_n", "Type" : "RtlSignal"}], "SubConnect" : []}],
		"WaitState" : [],
		"SubBlockPort" : []}]}
