...
(* CORE_GENERATION_INFO="axi_interfaces,hls_ip_2016_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.390000,HLS_SYN_LAT=129,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=186,HLS_SYN_LUT=55}" *)
...
reg    ap_sig_85;
wire   [15:0] tmp_5_fu_109_p1;
reg   [15:0] tmp_5_reg_151;
reg   [5:0] i_reg_64;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (exitcond_fu_79_p2 == 1'b0))) begin
...
assign tmp_3_fu_104_p2 = ($signed(acc_load_reg_136) + $signed(tmp_2_fu_101_p1));

assign tmp_5_fu_109_p1 = tmp_3_fu_104_p2[15:0];
