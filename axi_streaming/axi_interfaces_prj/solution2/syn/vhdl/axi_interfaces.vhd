...
architecture behav of axi_interfaces is 
    ...
    "axi_interfaces,hls_ip_2016_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.390000,HLS_SYN_LAT=129,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=186,HLS_SYN_LUT=55}";
    ...
    signal tmp_5_fu_109_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_5_reg_151 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3)) then
                tmp_3_reg_146 <= tmp_3_fu_104_p2;
                tmp_5_reg_151 <= tmp_5_fu_109_p1;
            end if;
        end if;
    end process;
    ...
    ap_sig_cseq_ST_st5_fsm_4_assign_proc : process(ap_sig_100)
    begin
        if (ap_sig_100) then 
    ...
    tmp_3_fu_104_p2 <= std_logic_vector(unsigned(acc_load_reg_136) + unsigned(tmp_2_fu_101_p1));
    tmp_5_fu_109_p1 <= tmp_3_fu_104_p2(16 - 1 downto 0);
